...
export default function SafetyOfficerPermitDetails() {
  ...
  {/* REMOVE THE DUPLICATE WRAPPER - Only Section 1: Permit Details */}
      ...
      <div className="space-y-6">
        <div className="bg-white rounded-lg shadow-md border border-slate-200 p-4 sm:p-6">
          ...
          <div className="mt-4 space-y-4">
            ...
            {/* Comments from Approver — only approver-to-safety entries (Gas Permit) */}
            <div className="mt-4 bg-yellow-50 p-3 rounded-md">
              <div className="text-md font-medium">Comments from Approver:</div>
              <div className="mt-2 space-y-1 text-sm">
                {form.approverToSafetyRequireUrgent && (
            ...
            {/* Comments from Requester — editable */}
            <div className="mt-4 bg-yellow-50 p-3 rounded-md">
              <div className="text-md font-medium">Comments for Requester:</div>
              <label className="flex items-center gap-2 mt-2">
                <input
